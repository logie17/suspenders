...
(custom-set-variables
 ...
 '(package-selected-packages
   '(racket-mode which-key web-mode visual-fill-column use-package typescript-mode smart-tab rainbow-delimiters org-bullets lsp-ui lsp-treemacs lsp-ivy js2-mode ivy-rich helpful gnuplot-mode gnuplot general forge evil-collection doom-themes doom-modeline counsel-projectile company-box)))
(custom-set-faces
